         ...
         public MethodVisitor visitMethod(final int access, final String name, final String descriptor, final String signature,
            ...
            return new MethodVisitor(Opcodes.ASM9) {
               ...
               private boolean isKnownNonNullMethod(final String clazz, final String methodName, final String descriptor) {
                  // CHECKSTYLE:IGNORE .* FOR NEXT 7 LINES
                  return methodName.equals("<init>") //
                        || methodName.equals("clone") && descriptor.startsWith("()L") //
               ...
               public void visitInsn(final int opcode) {
                  ...
                  switch (opcode) {
                     ...
                     case Opcodes.ARETURN:
                        ...
                        break;
                     case Opcodes.RETURN:
                        returnNullabilities.add(Nullability.NEVER_NULL);
                        // clear the operand stack after a primitive return
                        operandStackNullability.clear();
                        instructions.clear();
                        break;
                     case Opcodes.ATHROW:
                        // clear the operand stack after a throw
                        operandStackNullability.clear();
                        instructions.clear();
                        break;
                     case Opcodes.DUP:
                        if (operandStackNullability.isEmpty()) {
                           ...
                           operandStackNullability.push(operandStackNullability.peek());
                        }
                        break;
                     case Opcodes.POP:
                        if (!operandStackNullability.isEmpty()) {
               ...
               public void visitVarInsn(final int opcode, final int varIndex) {
                  ...
                  switch (opcode) {
                     case Opcodes.ALOAD:
                        ...
                        final var varNullability = localVariableNullability.getOrDefault(varIndex, Nullability.UNKNOWN);
                     ...
                     case Opcodes.ASTORE:
                        ...
                        if (!operandStackNullability.isEmpty()) { // CHECKSTYLE:IGNORE .*
                           final var valueNullability = operandStackNullability.pop();
