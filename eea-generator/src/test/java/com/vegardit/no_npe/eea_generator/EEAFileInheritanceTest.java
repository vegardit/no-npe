...
class EEAFileInheritanceTest {
   ...
   void testGenericInheritance() {
      final var computedEEAFiles = EEAGenerator.computeEEAFiles(EEAFileInheritanceTest.class.getPackageName(), c -> true);
      ...
      assertThat(classInfoB.getTypeSignatureStr()) //
         .isEqualTo("Lcom/vegardit/no_npe/eea_generator/EEAFileInheritanceTest$A<Ljava/util/HashMap<**>;>;");
      assertThat(classInfoC.getTypeSignatureStr()) //
         .isEqualTo("<T:Ljava/lang/Number;>Lcom/vegardit/no_npe/eea_generator/EEAFileInheritanceTest$A<Ljava/util/HashMap<**>;>;");
      assertThat(classInfoD.getTypeSignatureStr()) //
         .isEqualTo("<T::Ljava/util/concurrent/ConcurrentMap<**>;>Lcom/vegardit/no_npe/eea_generator/EEAFileInheritanceTest$A<TT;>;");
      ...
      assertThat(classInfoJ.getTypeSignatureStr()) //
         .isEqualTo("Ljava/lang/Object;Lcom/vegardit/no_npe/eea_generator/EEAFileInheritanceTest$I<Ljava/util/ArrayList<*>;>;");
      assertThat(classInfoK.getTypeSignatureStr()) //
         .isEqualTo("Ljava/lang/Throwable;Lcom/vegardit/no_npe/eea_generator/EEAFileInheritanceTest$I<Ljava/util/ArrayList<*>;>;"
      ...
      assertThat(linesA).isEqualTo(List.of( //
         "class com/vegardit/no_npe/eea_generator/EEAFileInheritanceTest$A", //
         " <T::Ljava/util/Map<**>;>", //
         " <T::Ljava/util/Map<**>;>" //
      ).stream().collect(Collectors.joining("\n")));

      assertThat(linesB).isEqualTo(List.of( //
         "class com/vegardit/no_npe/eea_generator/EEAFileInheritanceTest$B", //
         "", //
         "super com/vegardit/no_npe/eea_generator/EEAFileInheritanceTest$A", //
         " <Ljava/util/HashMap<**>;>", //
         " <Ljava/util/HashMap<**>;>" //
      ).stream().collect(Collectors.joining("\n")));

      assertThat(linesC).isEqualTo(List.of( //
         "class com/vegardit/no_npe/eea_generator/EEAFileInheritanceTest$C", //
         " <T:Ljava/lang/Number;>", //
         " <T:Ljava/lang/Number;>", //
         "", //
         "super com/vegardit/no_npe/eea_generator/EEAFileInheritanceTest$A", //
      ...
      assertThat(linesD).isEqualTo(List.of( //
         "class com/vegardit/no_npe/eea_generator/EEAFileInheritanceTest$D", //
      ...
      assertThat(linesI).isEqualTo(List.of( //
         "class com/vegardit/no_npe/eea_generator/EEAFileInheritanceTest$I", //
         " <T::Ljava/util/List<*>;>", //
         " <T::Ljava/util/List<*>;>" //
      ).stream().collect(Collectors.joining("\n")));

      assertThat(linesJ).startsWith(List.of( //
         "class com/vegardit/no_npe/eea_generator/EEAFileInheritanceTest$J", //
         "", //
         "super com/vegardit/no_npe/eea_generator/EEAFileInheritanceTest$I", //
         " <Ljava/util/ArrayList<*>;>", //
         " <Ljava/util/ArrayList<*>;>" //
      ).stream().collect(Collectors.joining("\n")));

      assertThat(linesK).startsWith(List.of( //
         "class com/vegardit/no_npe/eea_generator/EEAFileInheritanceTest$K", //
         "", //
         "super com/vegardit/no_npe/eea_generator/EEAFileInheritanceTest$I", //
         " <Ljava/util/ArrayList<*>;>", //
         " <Ljava/util/ArrayList<*>;>", //
